...
**UUTTA:** Olen laatinut moduulin **ana.py**, joka sisältää helppokäyttöisiä funktioita kuvailevaan ja selittävään analytiikkaan. Moduulin ja sen käyttöesimerkit löydät osoitteesta [https://github.com/taanila/ana](https://github.com/taanila/ana).
